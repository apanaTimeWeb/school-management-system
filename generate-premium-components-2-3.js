  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">${moduleName.replace('_', ' ').toUpperCase()}</h1>
...
generate("student_management", "02-student-management", studentItems);
generate("admission_management", "03-admission-management", admissionItems);
