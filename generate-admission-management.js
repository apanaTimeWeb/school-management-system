...
const componentsDir = path.join(__dirname, 'src/app/(app)/admin/03-admission-management/admission_management_components');
...
'}\n';
  ...
  pageImports += 'import ' + compName + ' from "./admission_management_components/' + compName + '";\n';
...
fs.writeFileSync(path.join(__dirname, 'src/app/(app)/admin/03-admission-management/page.tsx'), pageContent);

console.log("Successfully generated all 16 components independently.");
