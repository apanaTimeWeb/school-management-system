...
const MENU_ITEMS = [
  ...
  { href: '/principal/students', label: 'Student overview & performance', icon: <GraduationCap size={20} /> },
  ...
  { href: '/principal/staff', label: 'Staff & Teacher monitoring', icon: <GraduationCap size={20} /> },
