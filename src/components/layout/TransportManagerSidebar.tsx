...
export default function TransportManagerSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 z-50 h-screen w-[280px] bg-[#0891B2] border-r border-border transition-transform duration-300 ease-in-out
        ${isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
      `}>
        {/* Logo Area */}
        <div className="h-16 flex items-center justify-between px-6 border-b border-border/20 bg-[#0891B2] shrink-0">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-[18px] text-white tracking-tight">Transport<span className="text-secondary">Pro</span></span>
          </div>
          <button 
        ...
        <nav className="p-4 space-y-1.5 overflow-y-auto h-[calc(100vh-140px)] custom-scrollbar">
              ...
              <Link 
                ...
                className={`
                  ...
                  ${isActive 
                    ...
                    : 'text-white/60 hover:text-white hover:bg-[#0891B2]/50 border border-transparent'}
                `}
              >
          ...
          <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/60 hover:text-white hover:bg-[#0891B2]/50 transition-colors font-semibold text-[13px]">
        ...
        {/* Footer Area */}
        <div className="absolute bottom-0 left-0 w-full p-4 border-t border-border/20 bg-[#0891B2] shrink-0">
