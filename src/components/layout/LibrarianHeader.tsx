        ...
        <div ref={profileRef} className="relative">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col items-start leading-tight">
              <span className={clsx("text-sm font-semibold transition-colors", showProfileMenu ? "text-indigo-700" : "text-sidebar-text group-hover:text-indigo-600")}>Sarah J.</span>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-card border border-border rounded-lg shadow-xl overflow-hidden fade-in z-50 py-1">
              <Link href="/librarian/profile" className="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-text-primary hover:bg-bg-page hover:text-indigo-600 transition border-b border-border">
