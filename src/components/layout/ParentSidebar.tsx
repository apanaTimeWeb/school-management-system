...
const navItems = [
  // User's Checklist
  { label: 'Multiple children switcher', href: '/parent/children-switcher', icon: <Users size={20} /> },
  { label: 'Child Profile', href: '/parent/child-profile', icon: <UserCircle size={20} /> },
  { label: 'Academics', href: '/parent/academics', icon: <GraduationCap size={20} /> },
  ...
  { label: 'Exams', href: '/parent/exams', icon: <FileText size={20} /> },
  { label: 'Results', href: '/parent/results', icon: <Award size={20} /> },
  { label: 'Fees', href: '/parent/fees', icon: <Wallet size={20} /> },
  { label: 'Online Payment', href: '/parent/online-payment', icon: <Wallet size={20} /> },
  { label: 'Receipts', href: '/parent/receipts', icon: <ScrollText size={20} /> },
  { label: 'Leave Request', href: '/parent/leave-request', icon: <Calendar size={20} /> },
  ...
  { label: 'PTM', href: '/parent/ptm', icon: <Users size={20} /> },
  { label: 'Events', href: '/parent/events', icon: <Trophy size={20} /> },
  { label: 'Library', href: '/parent/library', icon: <BookOpen size={20} /> },
  { label: 'Transport', href: '/parent/transport', icon: <Bus size={20} /> },
  { label: 'Hostel', href: '/parent/hostel', icon: <Home size={20} /> },
  { label: 'Health', href: '/parent/health', icon: <HeartPulse size={20} /> },
  { label: 'Discipline', href: '/parent/discipline', icon: <Scale size={20} /> },
  { label: 'Certificates/Document Requests', href: '/parent/certificates', icon: <ScrollText size={20} /> },
  { label: 'Complaints/Grievance', href: '/parent/complaints', icon: <AlertCircle size={20} /> },
  ...
  { label: 'Security', href: '/parent/security', icon: <ShieldCheck size={20} /> },
  // Preserved defaults
