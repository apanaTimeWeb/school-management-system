...
const MENU_ITEMS = [
  ...
  { href: '/hr/employees', label: 'Employees', icon: <Users size={20} className="text-indigo-500" /> },
  { href: '/hr/teachers', label: 'Teachers', icon: <GraduationCap size={20} className="text-purple-500" /> },
  { href: '/hr/attendance', label: 'Staff Attendance', icon: <UserCheck size={20} className="text-emerald-500" /> },
  { href: '/hr/leaves', label: 'Leave Management', icon: <CalendarOff size={20} className="text-amber-500" /> },
  ...
  { href: '/hr/transfers', label: 'Transfer & Promotion', icon: <TrendingUp size={20} className="text-orange-500" /> },
  { href: '/hr/exit', label: 'Employee Exit', icon: <UserMinus size={20} className="text-red-500" /> },
  ...
  { href: '/hr/workload', label: 'Workload & Assignment', icon: <Briefcase size={20} className="text-violet-500" /> },
  ...
  { href: '/hr/meetings', label: 'Staff Meetings', icon: <Video size={20} className="text-blue-600" /> },
  { href: '/hr/assets', label: 'Employee Assets', icon: <Monitor size={20} className="text-indigo-600" /> },
