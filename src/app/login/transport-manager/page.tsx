  ...
  return (
    <div className="min-h-screen bg-bg-main flex items-center justify-center p-6 font-sans relative">
      ...
      <div className="bg-white border border-border rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="bg-teal-500/5 p-8 text-center border-b border-border">
        ...
        <div className="p-8">
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-input border border-border rounded-lg pl-10 pr-4 py-3 text-sm font-medium focus:border-teal-500 outline-none transition-colors"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-input border border-border rounded-lg pl-10 pr-4 py-3 text-sm font-medium focus:border-teal-500 outline-none transition-colors tracking-widest"
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="mt-4 w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3.5 rounded-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {loading ? (
