...
export default function ParentLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-main flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <Link href="/login" className="absolute top-8 left-8 flex items-center gap-2 text-text-secondary hover:text-pink-600 transition-colors font-semibold text-sm z-10">
      ...
      <div className="w-full max-w-md bg-white border border-border rounded-3xl p-8 shadow-2xl relative z-10 transform transition-all">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-20 h-20 rounded-full bg-pink-500/10 flex items-center justify-center mb-6 shadow-inner">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-bg-secondary border border-border rounded-xl text-text-primary focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 transition-all text-sm font-medium"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between ml-1">
              ...
              <Link href="#" className="text-xs font-semibold text-pink-600 hover:text-pink-700 hover:underline">Forgot password?</Link>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <input 
                ...
                className="w-full pl-11 pr-12 py-3 bg-bg-secondary border border-border rounded-xl text-text-primary focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 transition-all text-sm font-medium"
                required
              />
              <button 
                type="button" 
