  ...
  return (
    <div className="min-h-screen bg-bg-main flex flex-col items-center justify-center p-6 font-sans relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full max-w-7xl">
        ...
        {/* Student Card */}
        <Link href="/auth/login/student" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#0284C7] font-bold bg-[#F0F9FF] px-6 py-2.5 rounded-full group-hover:bg-[#0284C7] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* Parent Card */}
        <Link href="/auth/login/parent" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#B45309] font-bold bg-[#FFFBEB] px-6 py-2.5 rounded-full group-hover:bg-[#B45309] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* Teacher Card */}
        <Link href="/auth/login/teacher" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
        ...
        {/* Super Admin Card */}
        <Link href="/auth/login/super-admin" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
        ...
        {/* School Admin Card */}
        <Link href="/auth/login/school-admin" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
        ...
        {/* Principal Card */}
        <Link href="/auth/login/principal" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
        ...
        {/* Accountant Card */}
        <Link href="/auth/login/accountant" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#475569] font-bold bg-[#F8FAFC] px-6 py-2.5 rounded-full group-hover:bg-[#475569] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* HR / Office Card */}
        <Link href="/auth/login/hr" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#BE185D] font-bold bg-[#FDF2F8] px-6 py-2.5 rounded-full group-hover:bg-[#BE185D] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* Transport Manager Card */}
        <Link href="/auth/login/transport-manager" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#0891B2] font-bold bg-[#ECFEFF] px-6 py-2.5 rounded-full group-hover:bg-[#0891B2] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* Hostel Warden Card */}
        <Link href="/auth/login/hostel-warden" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-full bg-[#F0FDF4] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#166534] font-bold bg-[#F0FDF4] px-6 py-2.5 rounded-full group-hover:bg-[#166534] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        {/* Librarian Card */}
        <Link href="/auth/login/librarian" className="group bg-bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col items-center text-center">
          ...
          <div className="mt-auto flex items-center gap-2 text-[#6D28D9] font-bold bg-[#FAF5FF] px-6 py-2.5 rounded-full group-hover:bg-[#6D28D9] group-hover:text-white transition-colors w-full justify-center text-[14px]">
            Continue <ArrowRight size={16} />
          </div>
        </Link>
