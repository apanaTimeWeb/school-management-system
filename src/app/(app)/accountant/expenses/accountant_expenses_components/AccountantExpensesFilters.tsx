...
import { EXPENSE_CATEGORIES } from "../accountant_expenses_utils/AccountantExpensesConstants";

export default function AccountantExpensesFilters() {
  const { 
    searchQuery, setSearchQuery, 
    statusFilter, setStatusFilter,
    categoryFilter, setCategoryFilter,
    setNewExpenseModalOpen
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
        <div className="relative w-full sm:w-80">
          ...
          <input 
            ...
            placeholder="Search vendor or expense ID..." 
