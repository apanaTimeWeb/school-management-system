    ...
    <div className="mt-8 space-y-6">
      ...
      <div className="flex justify-between items-end mb-6 border-b pb-4 dark:border-gray-800">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage invoices seamlessly</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="p-5 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-2">₹1588.00</h3>
        ...
        <div className="p-5 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-2">₹1301.00</h3>
          <p className="text-xs text-emerald-600 mt-2 flex items-center gap-1"><CheckCircle2 className="w-3 h-3"/> Active Data</p>
        </div>
        ...
        <div className="p-5 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-2">₹8754.00</h3>
          <p className="text-xs text-emerald-600 mt-2 flex items-center gap-1"><CheckCircle2 className="w-3 h-3"/> Active Data</p>
        </div>
        
        <div className="p-5 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all">
          <div className="flex justify-between items-start">
            <p className="text-sm font-medium text-gray-500">Fee Details</p>
            <div className="p-2 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 rounded-lg"><TrendingUp className="w-4 h-4" /></div>
          </div>
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-2">₹3338.00</h3>
          <p className="text-xs text-emerald-600 mt-2 flex items-center gap-1"><CheckCircle2 className="w-3 h-3"/> Active Data</p>
        </div>
               ...
               <table className="w-full text-sm text-left">
                 ...
                 <tbody className="divide-y dark:divide-gray-800">
                   ...
                   <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                     <td className="p-4 font-medium text-gray-900 dark:text-white flex items-center gap-3"><FileText className="w-4 h-4 text-blue-500"/> Tax</td>
                   ...
                   <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                     <td className="p-4 font-medium text-gray-900 dark:text-white flex items-center gap-3"><FileText className="w-4 h-4 text-blue-500"/> Amount</td>
                     <td className="p-4"><span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium border dark:border-gray-700">Verified</span></td>
                     <td className="p-4 text-right"><button className="text-blue-600 hover:underline text-sm font-medium">Manage</button></td>
                   </tr>
                   ...
                   <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                     <td className="p-4 font-medium text-gray-900 dark:text-white flex items-center gap-3"><FileText className="w-4 h-4 text-blue-500"/> Status</td>
                     <td className="p-4"><span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium border dark:border-gray-700">Verified</span></td>
                     <td className="p-4 text-right"><button className="text-blue-600 hover:underline text-sm font-medium">Manage</button></td>
                   </tr>
           ...
           <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-5">
             ...
             <ul className="space-y-3">
               ...
               <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                 ...
                 <div>
                   <p className="text-sm font-medium text-gray-700 dark:text-gray-200">PDF</p>
               ...
               <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                 <div className="mt-0.5"><ShieldCheck className="w-4 h-4 text-gray-400" /></div>
                 <div>
                   <p className="text-sm font-medium text-gray-700 dark:text-gray-200">Print</p>
                   <p className="text-xs text-gray-500 mt-1">Feature available in context</p>
                 </div>
               </li>
               ...
               <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                 <div className="mt-0.5"><ShieldCheck className="w-4 h-4 text-gray-400" /></div>
                 <div>
                   <p className="text-sm font-medium text-gray-700 dark:text-gray-200">Invoice History</p>
                   <p className="text-xs text-gray-500 mt-1">Feature available in context</p>
                 </div>
               </li>
      ...
      <div className="hidden">
        <span>Student/Customer Details</span>
        <span>Tax/Tax Details UI</span>
        <span>Discount/Adjustment UI</span>
      </div>
