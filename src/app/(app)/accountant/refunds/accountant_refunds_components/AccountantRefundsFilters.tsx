...
export default function AccountantRefundsFilters() {
  const { 
    searchQuery, setSearchQuery, 
    statusFilter, setStatusFilter,
    setNewRefundModalOpen
  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm p-4 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
        <div className="relative w-full sm:w-80">
          ...
          <input 
            ...
            placeholder="Search request ID, student or reason..." 
        ...
        >
          ...
          <option value="Approved">Approved (Pending Processing)</option>
      ...
      <div className="flex gap-2 w-full xl:w-auto">
        ...
        >
          <PlusCircle size={16} /> Initiate Refund
        </button>
      </div>
