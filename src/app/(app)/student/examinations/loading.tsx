...
export default function StudentExaminationsLoading() {
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 md:p-6 lg:p-8 motion-safe:animate-pulse">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div className="flex-1 flex flex-col gap-6 w-full">
          ...
          <div className="w-full h-[140px] bg-card border border-border rounded-xl bg-skeleton-base"></div>
          
          {/* List Skeleton */}
          <div className="w-full h-[400px] bg-card border border-border rounded-xl bg-skeleton-base"></div>
        </div>
      </div>
    </div>
  );
