...
export default function StudentDisciplineError({
  error,
  reset,
}: {
  ...
  return (
    <div className="w-full h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-xl font-bold text-text-primary mb-2">Could not load records</h2>
      <p className="text-sm text-text-secondary max-w-md mb-6">
        There was an error connecting to the discipline module. Please check your connection and try again.
      </p>
      <button
        onClick={() => reset()}
