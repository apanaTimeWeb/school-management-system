...
export default function StudentAcademicsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="w-full h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-xl font-bold text-text-primary mb-2">Could not load academics data</h2>
      <p className="text-sm text-text-secondary max-w-md mb-6">
        There was an error loading your syllabus and subjects.
      </p>
      <button
        onClick={() => reset()}
