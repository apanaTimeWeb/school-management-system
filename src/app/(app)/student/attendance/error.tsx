...
export default function StudentAttendanceError({
  error,
  reset,
}: {
  ...
  return (
    <div className="w-full h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-xl font-bold text-text-primary mb-2">Could not load attendance data</h2>
      <p className="text-sm text-text-secondary max-w-md mb-6">
        There was an error fetching your attendance records. Please try again.
      </p>
      <button
        onClick={() => reset()}
