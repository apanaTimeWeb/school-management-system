    ...
    <div className="w-full max-w-[1400px] mx-auto p-4 md:p-6 lg:p-8 motion-safe:animate-pulse">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} className="bg-card border border-border rounded-xl p-5 h-[90px] bg-skeleton-base"></div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="bg-card border border-border rounded-xl p-5 h-[350px] bg-skeleton-base"></div>
            <div className="bg-card border border-border rounded-xl p-5 h-[250px] bg-skeleton-base"></div>
          </div>
          <div className="flex flex-col gap-6">
