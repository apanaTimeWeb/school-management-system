  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 md:p-6 lg:p-8 motion-safe:animate-pulse">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        {/* Sidebar Skeleton */}
        <div className="w-full lg:w-64 h-[250px] bg-card border border-border rounded-xl bg-skeleton-base shrink-0"></div>
        
        {/* Content Skeleton */}
        <div className="flex-1 w-full h-[400px] bg-card border border-border rounded-xl bg-skeleton-base"></div>
      </div>
    </div>
  );
}
