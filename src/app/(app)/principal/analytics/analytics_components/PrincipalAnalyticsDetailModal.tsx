          ...
          {selectedRiskStudent && (
            <>
              ...
              <div className="flex gap-2 mt-4">
                <button className="flex-1 py-2 bg-primary/10 hover:bg-primary border border-primary/30 hover:border-primary text-primary hover:text-black font-bold text-[13px] rounded transition-colors">
                  Schedule Meeting
                </button>
                <button className="flex-1 py-2 bg-info/10 hover:bg-info border border-info/30 hover:border-info text-info hover:text-black font-bold text-[13px] rounded transition-colors">
                  Send Warning Letter
                </button>
              </div>
            </>
