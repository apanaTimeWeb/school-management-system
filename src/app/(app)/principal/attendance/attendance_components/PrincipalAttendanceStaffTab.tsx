          ...
          <tbody>
            {staff.map((st) => (
              <tr key={st.id} className="border-b border-border/50 hover:bg-white/5 transition-colors group">
                ...
                <td className="p-4 text-center">
                  <button className="p-2 bg-info/10 border border-info/30 rounded-md text-info hover:bg-info hover:text-white hover:border-info transition-colors shadow-sm">
                    <Eye size={16} />
                  </button>
                </td>
              </tr>
