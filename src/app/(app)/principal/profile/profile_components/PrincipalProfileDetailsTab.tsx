      ...
      <div className="col-span-1 lg:col-span-2 space-y-6">
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
           ...
           <div className="mt-6 flex justify-end">
             <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.dispatchEvent(new CustomEvent('open-coming-soon', { detail: 'Action completed successfully!' })); }} className="px-6 py-2 bg-primary hover:bg-primary-hover text-white font-bold text-[13px] rounded-md transition-colors">
               Edit Profile
             </button>
           </div>
        </div>
