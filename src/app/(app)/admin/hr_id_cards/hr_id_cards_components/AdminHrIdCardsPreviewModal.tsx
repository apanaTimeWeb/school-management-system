...
import AdminHrIdCardVisual from "./AdminHrIdCardVisual";

interface AdminHrIdCardsPreviewModalProps {
...
export default function AdminHrIdCardsPreviewModal({ records, isOpen, close, markAsPrinted }: AdminHrIdCardsPreviewModalProps) {
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center bg-input/10">
          ...
          <div className="w-full flex items-center justify-center gap-8 mb-8">
            ...
            <div className="motion-safe:animate-in motion-safe:zoom-in-95">
              <AdminHrIdCardVisual record={currentRecord} />
            </div>
