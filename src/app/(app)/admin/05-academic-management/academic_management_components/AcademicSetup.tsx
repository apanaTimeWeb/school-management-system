            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-end">
                  <button className="w-full h-[38px] bg-primary text-white rounded-md text-sm font-bold shadow-sm hover:bg-primary-hover">Create Session</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 bg-bg-page p-4 border border-border rounded-lg">
                  ...
                  <button className="bg-primary text-white rounded-md text-sm font-bold py-1.5 mt-1 shadow-sm">Save Class</button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 bg-bg-page p-4 border border-border rounded-lg">
                  ...
                  <button className="bg-primary text-white rounded-md text-sm font-bold py-1.5 mt-1 shadow-sm">Add Section</button>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 fade-in">
            ...
            <div className="flex flex-col gap-4 bg-bg-page border border-border p-5 rounded-lg max-w-lg">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button className="bg-primary text-white rounded-md text-sm font-bold py-2 mt-2 shadow-sm">Add House</button>
              </div>
            </div>
