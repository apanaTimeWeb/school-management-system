import AdminHrEmployeesAddMain from "./hr_employees_add_components/AdminHrEmployeesAddMain";
...
export default function AdminHrEmployeesAddPage() {
  return (
