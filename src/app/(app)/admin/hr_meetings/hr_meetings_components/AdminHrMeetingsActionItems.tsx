...
import type { ActionItem } from "../hr_meetings_types/AdminHrMeetingsTypes";

interface AdminHrMeetingsActionItemsProps {
  actionItems: (ActionItem & { meetingTitle: string })[];
}

export default function AdminHrMeetingsActionItems({ actionItems }: AdminHrMeetingsActionItemsProps) {
