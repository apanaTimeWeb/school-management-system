...
const adminCategories = [
  ...
  { id: "examinations", title: "07. Examinations & Results", icon: LayoutDashboard, href: "/admin/07-examination-management" },
  { id: "fees", title: "08. Fees & Finance", icon: LayoutDashboard, href: "/admin/08-fee-management" },
  { id: "staff", title: "09. Staff & HR", icon: LayoutDashboard, href: "/admin/09-staff-management" },
  { id: "leave", title: "10. Leave Management", icon: LayoutDashboard, href: "/admin/10-leave-management" },
  { id: "communication", title: "11. Communication", icon: LayoutDashboard, href: "/admin/11-communication" },
  { id: "timetable", title: "12. Timetable", icon: LayoutDashboard, href: "/admin/12-timetable" },
  { id: "transport", title: "13. Transport Management", icon: LayoutDashboard, href: "/admin/13-transport-management" },
  { id: "library", title: "14. Library", icon: LayoutDashboard, href: "/admin/14-library" },
  { id: "inventory", title: "15. Inventory & Assets", icon: LayoutDashboard, href: "/admin/15-inventory-assets" },
  { id: "purchase", title: "16. Purchase & Expenses", icon: LayoutDashboard, href: "/admin/16-purchase-expense" },
  { id: "events", title: "17. Events & Activities", icon: LayoutDashboard, href: "/admin/17-events-activities" },
