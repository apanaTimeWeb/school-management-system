...
const adminCategories = [
  ...
  { id: "staff", title: "09. HR/Office", icon: School, href: "/admin/09-staff-management", items: ["Staff management", "Leave oversight", "Employee operations", "Office administration"] },
  ...
  { id: "transport", title: "13. Transport", icon: School, href: "/admin/13-transport-management", items: ["Transport"] },
  { id: "library", title: "14. Library", icon: School, href: "/admin/14-library", items: ["Library"] },
  ...
  { id: "events", title: "16. Events & Activities", icon: School, href: "/admin/17-events-activities", items: [] },
  { id: "documents", title: "17. Documents", icon: School, href: "/admin/18-documents-certificates", items: ["Certificates", "TC", "Bonafide", "Character Certificate", "Study Certificate", "ID Card", "Document numbering", "QR verification"] },
  { id: "discipline", title: "18. Discipline & Grievance", icon: School, href: "/admin/19-discipline-grievance", items: [] },
  { id: "health", title: "19. Health & Medical", icon: School, href: "/admin/20-health-medical", items: [] },
  { id: "website", title: "20. Website/Public Content", icon: School, href: "/admin/21-website-content", items: ["News", "Events", "Gallery", "Notices", "Public content"] },
  { id: "reports", title: "21. Reports & Analytics", icon: School, href: "/admin/22-reports", items: [] },
  { id: "approval", title: "22. Approval Center", icon: School, href: "/admin/23-approval-center", items: ["Admission approval", "Leave approval", "Requests", "Certificates", "Other school workflows"] },
  { id: "search", title: "23. Search & Filters", icon: School, href: "/admin/24-search-filters", items: [] },
  { id: "settings", title: "24. Settings", icon: School, href: "/admin/25-settings", items: [] },
  { id: "security", title: "25. Security", icon: School, href: "/admin/26-security", items: [] },
  { id: "audit", title: "26. Audit Ledger", icon: School, href: "/admin/27-audit", items: [] },
  { id: "hostel", title: "27. Hostel", icon: School, href: "/admin/28-hostel", items: ["Hostel"] },
  { id: "profile", title: "28. My Profile", icon: School, href: "/admin/my-profile", items: [] }
];
