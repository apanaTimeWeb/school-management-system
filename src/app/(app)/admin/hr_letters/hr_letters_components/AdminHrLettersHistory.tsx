...
import type { GeneratedLetter } from "../hr_letters_types/AdminHrLettersTypes";

interface AdminHrLettersHistoryProps {
  history: GeneratedLetter[];
  histType: string; setHistType: (s: string) => void;
  histSearch: string; setHistSearch: (s: string) => void;
}

export default function AdminHrLettersHistory({
  history, histType, setHistType, histSearch, setHistSearch
}: AdminHrLettersHistoryProps) {
