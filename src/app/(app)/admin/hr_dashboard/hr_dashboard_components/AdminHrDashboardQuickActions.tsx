...
export default function AdminHrDashboardQuickActions() {
  ...
  const actions = [
    { label: "Add Staff", icon: <UserPlus size={24} />, color: "text-primary", bg: "bg-primary/10", hoverBg: "group-hover:bg-primary", route: "/admin/hr_staff/add" },
    { label: "Apply Leave", icon: <CalendarPlus size={24} />, color: "text-success", bg: "bg-success/10", hoverBg: "group-hover:bg-success", route: "/admin/hr_leaves/apply" },
    { label: "Upload Doc", icon: <Upload size={24} />, color: "text-info", bg: "bg-info/10", hoverBg: "group-hover:bg-info", route: "/admin/hr_documents/upload" },
    { label: "Permissions", icon: <ShieldCheck size={24} />, color: "text-purple-500", bg: "bg-purple-500/10", hoverBg: "group-hover:bg-purple-500", route: "/admin/hr_permissions" },
  ];
