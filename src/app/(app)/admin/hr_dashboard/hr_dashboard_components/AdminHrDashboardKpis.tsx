...
interface AdminHrDashboardKpisProps {
  stats: HrDashboardStats;
}

export default function AdminHrDashboardKpis({ stats }: AdminHrDashboardKpisProps) {
  ...
  const kpis = [
    ...
    },
    {
      ...
      trend: "Steady",
      trendUp: true,
      route: "/admin/hr_staff?status=active",
    ...
    },
    {
      ...
      trend: "—",
      trendUp: true,
      route: "/admin/hr_staff?role=teacher",
    ...
    },
    {
      ...
      trend: "—",
      trendUp: true,
      route: "/admin/hr_staff?role=non-teaching",
      bgClass: "bg-info/10",
