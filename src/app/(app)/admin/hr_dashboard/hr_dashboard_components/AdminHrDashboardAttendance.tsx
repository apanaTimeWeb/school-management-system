...
import type { HrDashboardStats } from "../hr_dashboard_types/AdminHrDashboardTypes";

interface AdminHrDashboardAttendanceProps {
  stats: HrDashboardStats;
}

export default function AdminHrDashboardAttendance({ stats }: AdminHrDashboardAttendanceProps) {
  ...
  const kpis = [
    {
      ...
      route: "/admin/hr_attendance?date=today",
    ...
    },
    {
      ...
      route: "/admin/hr_attendance?status=absent",
    ...
    },
    {
      ...
      route: "/admin/hr_staff?filter=new",
      bgClass: "bg-info/10",
