...
import type { HrAlert } from "../hr_dashboard_types/AdminHrDashboardTypes";

interface AdminHrDashboardAlertsProps {
  alerts: HrAlert[];
}

export default function AdminHrDashboardAlerts({ alerts }: AdminHrDashboardAlertsProps) {
