...
import type { CommMessage, CommCategory } from "../hr_communication_types/AdminHrCommTypes";

interface AdminHrCommBroadcastModalProps {
  isOpen: boolean;
  close: () => void;
  sendBroadcast: (msg: CommMessage) => void;
}

export default function AdminHrCommBroadcastModal({ isOpen, close, sendBroadcast }: AdminHrCommBroadcastModalProps) {
