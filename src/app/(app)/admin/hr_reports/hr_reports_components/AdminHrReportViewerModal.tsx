...
import { X, Play, Download, Printer, Loader2 } from "lucide-react";
import type { ReportDefinition, ReportFilterState, GeneratedReportRow } from "../hr_reports_types/AdminHrReportsTypes";

interface AdminHrReportViewerModalProps {
