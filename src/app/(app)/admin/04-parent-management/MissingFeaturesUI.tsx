  ...
  return (
    <div className="mt-8 flex flex-col gap-6 w-full max-w-7xl mx-auto pb-10">
      <div className="flex flex-col mb-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Advanced settings and features for 04 parent management</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Parent List</h3>
            <span className="px-2.5 py-1 bg-primary/10 text-primary text-xs font-medium rounded-full">New</span>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">Configure and manage parent list settings seamlessly.</p>
        ...
        <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Multiple Children</h3>
            <span className="px-2.5 py-1 bg-primary/10 text-primary text-xs font-medium rounded-full">New</span>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">Configure and manage multiple children settings seamlessly.</p>
          <div className="flex gap-3">
            <button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors shadow-sm">
              Manage Multiple
            </button>
