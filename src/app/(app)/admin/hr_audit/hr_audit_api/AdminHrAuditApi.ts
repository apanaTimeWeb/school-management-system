import type { AuditLog, AuditFiltersState, AuditResponse } from '../hr_audit_types/AdminHrAuditTypes';
import { MOCK_AUDIT_LOGS } from '../hr_audit_constants/AdminHrAuditConstants';
