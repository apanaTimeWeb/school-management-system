...
import type { EmployeeVault, VerificationStatus, DocumentCategory } from "../hr_documents_types/AdminHrDocumentsTypes";

interface AdminHrDocumentsEmployeeModalProps {
  employee: EmployeeVault | null;
  close: () => void;
  updateStatus: (empId: string, docId: string, status: VerificationStatus) => void;
}

export default function AdminHrDocumentsEmployeeModal({ employee, close, updateStatus }: AdminHrDocumentsEmployeeModalProps) {
