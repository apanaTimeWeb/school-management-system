...
import type { DocumentAlert } from "../hr_documents_types/AdminHrDocumentsTypes";

interface AdminHrDocumentsAlertsProps {
  alerts: DocumentAlert[];
}

export default function AdminHrDocumentsAlerts({ alerts }: AdminHrDocumentsAlertsProps) {
  if (alerts.length === 0) {
    return (
