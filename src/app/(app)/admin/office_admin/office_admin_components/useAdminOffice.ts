...
import { fetchNotices, fetchTasks, fetchDocuments } from "../office_admin_api/AdminOfficeApi";
import type { OfficeNotice, OfficeTask, OfficeDocument } from "../office_admin_types/AdminOfficeTypes";

export function useAdminOffice() {
