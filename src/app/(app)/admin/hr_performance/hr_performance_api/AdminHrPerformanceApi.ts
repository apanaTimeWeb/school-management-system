import type { EmployeePerformanceRecord, FetchPerformanceParams, PerformanceResponse } from '../hr_performance_types/AdminHrPerformanceTypes';
import { MOCK_PERFORMANCE_RECORDS } from '../hr_performance_constants/AdminHrPerformanceConstants';
