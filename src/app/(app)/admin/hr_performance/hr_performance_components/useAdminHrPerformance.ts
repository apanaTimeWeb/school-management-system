...
import { fetchActiveAppraisals, fetchPerformanceHistory } from "../hr_performance_api/AdminHrPerformanceApi";
import type { EmployeePerformanceRecord, AppraisalStatus } from "../hr_performance_types/AdminHrPerformanceTypes";

export function useAdminHrPerformance() {
