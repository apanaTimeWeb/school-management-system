...
interface AdminHrPerformanceModalProps {
...
export default function AdminHrPerformanceModal({ record, close, updateGoal, submitAppraisal }: AdminHrPerformanceModalProps) {
