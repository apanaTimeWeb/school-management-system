...
interface AdminHrTeachersProfileTabsProps {
  teacher: Teacher;
  activeTab: string;
  setActiveTab: (tab: string) => void;
}

export default function AdminHrTeachersProfileTabs({ teacher, activeTab, setActiveTab }: AdminHrTeachersProfileTabsProps) {
