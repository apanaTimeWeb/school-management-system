...
export default function AdminLateAbsentTrackingConfig() {
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden mb-6">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col gap-4">
          <h3 className="text-md font-bold text-text-primary border-b border-border pb-2">Manage Late/Absent Tracking</h3>
