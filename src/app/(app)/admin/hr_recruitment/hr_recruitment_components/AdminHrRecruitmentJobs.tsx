...
import type { JobPosition } from "../hr_recruitment_types/AdminHrRecruitmentTypes";
import { Users, Building, MapPin, Briefcase } from "lucide-react";

interface AdminHrRecruitmentJobsProps {
  jobs: JobPosition[];
  jobStatus: string;
  setJobStatus: (s: string) => void;
}

export default function AdminHrRecruitmentJobs({ jobs, jobStatus, setJobStatus }: AdminHrRecruitmentJobsProps) {
  return (
