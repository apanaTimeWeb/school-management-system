...
import { fetchJobPositions, fetchApplications } from "../hr_recruitment_api/AdminHrRecruitmentApi";
import type { JobPosition, CandidateApplication, PipelineStatus } from "../hr_recruitment_types/AdminHrRecruitmentTypes";

export function useAdminHrRecruitment() {
