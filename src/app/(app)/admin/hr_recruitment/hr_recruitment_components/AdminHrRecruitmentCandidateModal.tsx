...
import type { CandidateApplication, PipelineStatus } from "../hr_recruitment_types/AdminHrRecruitmentTypes";

interface AdminHrRecruitmentCandidateModalProps {
  candidate: CandidateApplication | null;
  close: () => void;
  updateStatus: (id: string, newStatus: PipelineStatus, note: string) => void;
}

export default function AdminHrRecruitmentCandidateModal({ candidate, close, updateStatus }: AdminHrRecruitmentCandidateModalProps) {
