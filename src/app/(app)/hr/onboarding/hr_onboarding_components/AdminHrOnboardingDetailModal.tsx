...
interface AdminHrOnboardingDetailModalProps {
...
export default function AdminHrOnboardingDetailModal({ candidate, close, toggleChecklist, verifyDocument, grantSystemAccess }: AdminHrOnboardingDetailModalProps) {
