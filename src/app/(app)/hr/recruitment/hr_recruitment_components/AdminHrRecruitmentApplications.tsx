...
import type { CandidateApplication, JobPosition } from "../hr_recruitment_types/AdminHrRecruitmentTypes";

interface AdminHrRecruitmentApplicationsProps {
