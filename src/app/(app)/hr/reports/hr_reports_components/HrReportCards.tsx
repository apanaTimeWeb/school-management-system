...
import { REPORT_DEFINITIONS } from "../hr_reports_constants/HrReportsConstants";
import type { ReportDefinition } from "../hr_reports_types/HrReportsTypes";
import { FileBarChart2, Users, PieChart, ShieldAlert, Lock, Unlock } from "lucide-react";

interface HrReportCardsProps {
  openReport: (r: ReportDefinition) => void;
  hasPaymentAuthority: boolean;
}

export default function HrReportCards({ openReport, hasPaymentAuthority }: HrReportCardsProps) {
