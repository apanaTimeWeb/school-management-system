...
import type { StaffMeeting, ActionItem, ActionItemStatus, MeetingStatus } from "../hr_meetings_types/HrMeetingsTypes";

interface HrMeetingModalProps {
...
export default function HrMeetingModal({ meeting, isOpen, close, save }: HrMeetingModalProps) {
