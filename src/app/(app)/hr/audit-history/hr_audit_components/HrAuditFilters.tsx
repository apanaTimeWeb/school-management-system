...
import type { AuditFiltersState } from "../hr_audit_types/HrAuditTypes";

interface HrAuditFiltersProps {
  filters: AuditFiltersState;
  setFilters: React.Dispatch<React.SetStateAction<AuditFiltersState>>;
  clearFilters: () => void;
}

export default function HrAuditFilters({ filters, setFilters, clearFilters }: HrAuditFiltersProps) {
