...
import type { AuditLog, AuditActionType } from "../hr_audit_types/AdminHrAuditTypes";

interface AdminHrAuditListProps {
  logs: AuditLog[];
  isLoading: boolean;
  openDiffModal: (log: AuditLog) => void;
}

export default function AdminHrAuditList({ logs, isLoading, openDiffModal }: AdminHrAuditListProps) {
