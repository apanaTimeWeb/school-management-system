import type { EmployeeSearchResult, SearchFiltersState, SearchResponse } from '../hr_search_types/HrSearchTypes';
import { MOCK_SEARCH_DATABASE } from '../hr_search_constants/HrSearchConstants';
