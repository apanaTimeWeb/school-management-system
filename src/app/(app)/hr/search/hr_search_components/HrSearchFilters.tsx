...
import type { SearchFiltersState } from "../hr_search_types/HrSearchTypes";

interface HrSearchFiltersProps {
  filters: SearchFiltersState;
  setFilters: React.Dispatch<React.SetStateAction<SearchFiltersState>>;
  clearFilters: () => void;
}

export default function HrSearchFilters({ filters, setFilters, clearFilters }: HrSearchFiltersProps) {
