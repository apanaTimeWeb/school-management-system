import type { LetterTemplate, GeneratedLetter, FetchLettersParams, LettersResponse } from '../hr_letters_types/HrLettersTypes';
import { MOCK_LETTER_TEMPLATES, MOCK_GENERATED_LETTERS } from '../hr_letters_constants/HrLettersConstants';
