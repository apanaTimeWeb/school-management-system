...
interface AdminHrLettersGeneratorModalProps {
  template: LetterTemplate | null;
  close: () => void;
  saveLetter: (employeeName: string) => void;
}

export default function AdminHrLettersGeneratorModal({ template, close, saveLetter }: AdminHrLettersGeneratorModalProps) {
