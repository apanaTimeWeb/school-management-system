import type { OfficeNotice, OfficeTask, OfficeDocument, FetchOfficeParams, OfficeResponse } from '../office_admin_types/AdminOfficeTypes';
import { MOCK_NOTICES, MOCK_TASKS, MOCK_DOCUMENTS } from '../office_admin_constants/AdminOfficeConstants';
