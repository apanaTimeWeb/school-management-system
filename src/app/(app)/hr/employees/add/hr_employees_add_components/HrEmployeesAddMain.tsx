...
import { useHrEmployeesAdd } from "./useHrEmployeesAdd";
import HrEmployeesAddStepper from "./HrEmployeesAddStepper";
import { Loader2 } from "lucide-react";

export default function HrEmployeesAddMain() {
  const { currentStep, formData, updateFormData, nextStep, prevStep, submitForm, isSubmitting } = useHrEmployeesAdd();

  return (
    <div className="w-full max-w-3xl mx-auto bg-card border border-border rounded-xl shadow-lg p-6 md:p-8">
      <HrEmployeesAddStepper currentStep={currentStep} />
