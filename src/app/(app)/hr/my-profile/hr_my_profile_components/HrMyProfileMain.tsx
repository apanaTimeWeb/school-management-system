...
import { useHrMyProfile } from "./useHrMyProfile";
import HrProfileTab from "./HrProfileTab";
import HrSecurityTab from "./HrSecurityTab";
import HrSessionsTab from "./HrSessionsTab";
import Hr2faModal from "./Hr2faModal";

export default function HrMyProfileMain() {
  const {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 w-full items-start">
      ...
      <div className="flex-1 w-full min-w-0">
        {activeTab === 'Profile' && (
          <HrProfileTab profile={profile} handleSave={handleProfileSave} />
        )}
        
        {activeTab === 'Security' && (
          <HrSecurityTab profile={profile} handle2FAToggle={handle2FAToggle} />
        )}
