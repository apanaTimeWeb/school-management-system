...
interface HrPayrollDetailModalProps {
...
export default function HrPayrollDetailModal({ record, close, updateStatus, hasPaymentAuthority }: HrPayrollDetailModalProps) {
