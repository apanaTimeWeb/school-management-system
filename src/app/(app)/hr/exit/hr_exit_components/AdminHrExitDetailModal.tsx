...
interface AdminHrExitDetailModalProps {
...
export default function AdminHrExitDetailModal({ exitRecord, close, toggleClearance, markRelieved }: AdminHrExitDetailModalProps) {
