...
import AdminHrTeacherEditModal from "./AdminHrTeacherEditModal";
import AdminHrTeacherStatusModal from "./AdminHrTeacherStatusModal";

interface AdminHrTeachersTableProps {
  teachers: Teacher[];
}

export default function AdminHrTeachersTable({ teachers: initialTeachers }: AdminHrTeachersTableProps) {
