...
import { fetchWorkloadList } from "../hr_workload_api/AdminHrWorkloadApi";
import type { TeacherWorkloadRecord, AcademicAssignment } from "../hr_workload_types/AdminHrWorkloadTypes";

export function useAdminHrWorkload() {
