...
import type { TeacherWorkloadRecord, AcademicAssignment, AdditionalResponsibility } from "../hr_workload_types/HrWorkloadTypes";

interface HrWorkloadModalProps {
  record: TeacherWorkloadRecord | null;
  close: () => void;
  save: (record: TeacherWorkloadRecord) => void;
}

export default function HrWorkloadModal({ record, close, save }: HrWorkloadModalProps) {
