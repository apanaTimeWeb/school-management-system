import type { TeacherWorkloadRecord, FetchWorkloadParams, WorkloadResponse } from '../hr_workload_types/HrWorkloadTypes';
import { MOCK_WORKLOAD_RECORDS } from '../hr_workload_constants/HrWorkloadConstants';
