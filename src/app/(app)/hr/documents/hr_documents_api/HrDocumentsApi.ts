import type { EmployeeVault, DocumentAlert, FetchVaultParams, DocumentsResponse } from '../hr_documents_types/HrDocumentsTypes';
import { MOCK_VAULT_LIST, MOCK_DOCUMENT_ALERTS } from '../hr_documents_constants/HrDocumentsConstants';
