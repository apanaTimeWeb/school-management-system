...
import type { CommChannelConfig } from "../hr_communication_types/HrCommTypes";

interface HrCommChannelsProps {
  channels: CommChannelConfig[];
  toggleChannelStatus: (id: string) => void;
}

export default function HrCommChannels({ channels, toggleChannelStatus }: HrCommChannelsProps) {
