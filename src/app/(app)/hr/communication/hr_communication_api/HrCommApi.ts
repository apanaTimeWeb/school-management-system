import type { CommMessage, CommChannelConfig, FetchCommParams, CommResponse } from '../hr_communication_types/HrCommTypes';
import { MOCK_MESSAGES, MOCK_CHANNELS } from '../hr_communication_constants/HrCommConstants';
