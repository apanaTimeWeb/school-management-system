import type { EmployeeAsset, FetchAssetParams, AssetResponse } from '../hr_assets_types/HrAssetsTypes';
import { MOCK_ASSETS } from '../hr_assets_constants/HrAssetsConstants';
