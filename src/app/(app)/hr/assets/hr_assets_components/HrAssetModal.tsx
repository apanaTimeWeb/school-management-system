...
import type { EmployeeAsset, AssetCategory, AssetStatus } from "../hr_assets_types/HrAssetsTypes";

interface HrAssetModalProps {
...
export default function HrAssetModal({ asset, isOpen, close, save }: HrAssetModalProps) {
