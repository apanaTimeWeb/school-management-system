...
import type { HrDashboardStats, UpcomingEvent } from "../hr_dashboard_types/HrDashboardTypes";

interface HrDashboardEventsProps {
  stats: HrDashboardStats;
}

export default function HrDashboardEvents({ stats }: HrDashboardEventsProps) {
