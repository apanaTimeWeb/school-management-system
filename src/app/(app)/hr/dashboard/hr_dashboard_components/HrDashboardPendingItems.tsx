...
import type { HrDashboardStats, PendingItem } from "../hr_dashboard_types/HrDashboardTypes";

interface HrDashboardPendingItemsProps {
  stats: HrDashboardStats;
}

export default function HrDashboardPendingItems({ stats }: HrDashboardPendingItemsProps) {
