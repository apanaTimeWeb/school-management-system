...
import type { AttendanceStatus } from "../hr_staff_attendance_types/AdminHrStaffAttendanceTypes";
...
export default function AdminHrStaffAttendanceCorrectionModal({ isOpen, close, context, onSave }: AdminHrStaffAttendanceCorrectionModalProps) {
