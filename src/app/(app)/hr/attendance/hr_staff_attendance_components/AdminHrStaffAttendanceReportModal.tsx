...
interface AdminHrStaffAttendanceReportModalProps {
  isOpen: boolean;
  onClose: () => void;
  date: string;
  month: number;
...
export default function AdminHrStaffAttendanceReportModal({ isOpen, onClose, date, month, year, activeTab }: AdminHrStaffAttendanceReportModalProps) {
