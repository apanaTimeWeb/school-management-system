...
import type { MonthlyAttendanceRecord, AttendanceStatus } from "../hr_staff_attendance_types/HrStaffAttendanceTypes";

interface HrStaffAttendanceMonthlyProps {
  records: MonthlyAttendanceRecord[];
  openCorrection: (empId: string, name: string, day: number) => void;
}

export default function HrStaffAttendanceMonthly({ records, openCorrection }: HrStaffAttendanceMonthlyProps) {
