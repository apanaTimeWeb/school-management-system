...
|---|---|---|
| Tabs (Daily vs Monthly) | `HrStaffAttendanceToolbar` | ✅ MOCKED |
| Date & Month Filters | `HrStaffAttendanceToolbar` | ✅ MOCKED |
| Sync Biometric & Reports | `HrStaffAttendanceToolbar` | ✅ INTERACTIVE |
| Mark Daily Attendance | `HrStaffAttendanceDaily` | ✅ MOCKED (Interactive) |
| Monthly Register Grid | `HrStaffAttendanceMonthly` | ✅ MOCKED |
| Attendance Correction Modal| `HrStaffAttendanceCorrectionModal`| ✅ MOCKED |
...
5. **Interaction Check:** A premium blur-modal opens (`HrStaffAttendanceCorrectionModal`). The modal specifies the Employee Name and the exact Day. User inputs the new status and a reason, then saves.
...
- **Rule 6 (Hooks Isolation):** `useHrStaffAttendance` manages all tab switching, filtering, fetching, and modal toggling logic.
