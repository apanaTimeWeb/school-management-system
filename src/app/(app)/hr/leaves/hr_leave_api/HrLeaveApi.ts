import type { LeaveApplication, LeaveBalance, LeaveType, Holiday, FetchLeaveParams, LeaveResponse } from '../hr_leave_types/HrLeaveTypes';
import { MOCK_LEAVE_APPLICATIONS, MOCK_LEAVE_BALANCES, MOCK_LEAVE_TYPES, MOCK_HOLIDAYS } from '../hr_leave_constants/HrLeaveConstants';
