...
import type { LeaveApplication } from "../hr_leave_types/HrLeaveTypes";

interface HrLeaveActionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function HrLeaveActionModal({ isOpen, onClose, application, action, onConfirm }: HrLeaveActionModalProps) {
