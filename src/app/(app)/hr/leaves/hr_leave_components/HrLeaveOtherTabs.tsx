...
import type { LeaveBalance, LeaveType, Holiday } from "../hr_leave_types/HrLeaveTypes";

export function HrLeaveBalances({ balances }: { balances: LeaveBalance[] }) {
...
export function HrLeaveTypes({ types }: { types: LeaveType[] }) {
  return (
...
export function HrLeaveHolidayCalendar({ holidays }: { holidays: Holiday[] }) {
  return (
