...
import type { TransferType } from "../hr_transfer_types/HrTransferTypes";

interface HrTransferInitiateModalProps {
  isOpen: boolean;
  close: () => void;
  submit: (data: any) => void;
}

export default function HrTransferInitiateModal({ isOpen, close, submit }: HrTransferInitiateModalProps) {
