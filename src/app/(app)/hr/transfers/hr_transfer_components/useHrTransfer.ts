...
import { fetchTransferRequests, fetchTransferHistory } from "../hr_transfer_api/HrTransferApi";
import type { TransferRequest, TransferStatus } from "../hr_transfer_types/HrTransferTypes";

export function useHrTransfer() {
