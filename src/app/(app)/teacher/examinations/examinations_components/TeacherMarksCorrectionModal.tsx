        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="pt-4 border-t border-border flex justify-end gap-3 items-center">
            ...
            <button 
              ...
              className="px-5 py-2.5 bg-primary text-white font-bold text-[14px] rounded-lg hover:bg-primary/90 flex items-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
