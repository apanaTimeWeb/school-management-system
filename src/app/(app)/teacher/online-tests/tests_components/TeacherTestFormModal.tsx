    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm transition-opacity p-4">
      <div className="w-full max-w-4xl bg-bg-main shadow-2xl rounded-2xl border border-border overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-t border-border flex justify-end gap-3 bg-card shrink-0 items-center">
          ...
          <button type="button" onClick={(e) => handleSubmit(e, true)} disabled={!!successMessage} className="px-5 py-2.5 bg-primary text-white font-bold text-[14px] rounded-lg hover:bg-primary/90 flex items-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
