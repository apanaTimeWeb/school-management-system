...
const MENU_STRUCTURE = [
  ...
  { title: "02. Organization Management", icon: Shield, href: "/super-admin/02-organization-management", items: ["School", "Branches", "Campuses"] },
  { title: "03. Academic Setup", icon: Shield, href: "/super-admin/03-academic-setup", items: ["Sessions", "Classes", "Subjects"] },
  { title: "04. Users & Access", icon: Shield, href: "/super-admin/04-users-access", items: ["Users", "Roles", "Permissions"] },
  { title: "05. System Settings", icon: Shield, href: "/super-admin/05-system-settings", items: ["General", "Localization"] },
  { title: "06. Communication", icon: Shield, href: "/super-admin/06-communication", items: ["SMS", "Email", "Templates"] },
  { title: "07. Finance Config", icon: Shield, href: "/super-admin/07-finance-configuration", items: ["Payment Gateway", "Fee Masters"] },
  { title: "08. HR Config", icon: Shield, href: "/super-admin/08-hr-configuration", items: ["Employee Types", "Leave Policies"] },
  { title: "09. Library Config", icon: Shield, href: "/super-admin/09-library-configuration", items: ["Categories", "Rules"] },
  { title: "10. Transport Config", icon: Shield, href: "/super-admin/10-transport-configuration", items: ["Vehicles", "Routes"] },
  { title: "11. Hostel Config", icon: Shield, href: "/super-admin/11-hostel-configuration", items: ["Hostels", "Rooms"] },
  { title: "12. Docs & Certificates", icon: Shield, href: "/super-admin/12-documents-certificates", items: ["Types", "Templates"] },
  { title: "13. Integrations", icon: Shield, href: "/super-admin/13-integrations", items: ["APIs", "Webhooks"] },
  { title: "14. Data Management", icon: Shield, href: "/super-admin/14-data-management", items: ["Import", "Export", "Backup"] },
  { title: "15. Approval Workflow", icon: Shield, href: "/super-admin/15-approval-workflow", items: ["Builder", "Rules"] },
  { title: "16. Automation", icon: Shield, href: "/super-admin/16-automation", items: ["Rules", "Jobs"] },
  { title: "17. Reports & Analytics", icon: Shield, href: "/super-admin/17-reports-analytics", items: ["System", "Activity"] },
  { title: "18. Audit & Security", icon: Shield, href: "/super-admin/18-audit-security", items: ["Audit Logs", "Security Alerts"] },
  { title: "19. System Health", icon: Shield, href: "/super-admin/19-system-health", items: ["Server", "Database"] },
  ...
  { title: "22. Maintenance Mode", icon: Shield, href: "/super-admin/22-maintenance-mode", items: ["Schedule", "History"] },
  { title: "23. Module Management", icon: Shield, href: "/super-admin/23-module-management", items: ["Enable", "Disable"] },
  { title: "24. Deleted Data", icon: Shield, href: "/super-admin/24-deleted-data-recovery", items: ["Restore", "Permanent Delete"] },
