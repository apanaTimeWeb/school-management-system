              ...
              <tr key={wing.id} className="hover:bg-bg-page transition-colors group cursor-pointer">
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <button className={cn("p-1 rounded transition-colors", wing.isActive ? "text-warning hover:bg-warning/10" : "text-success hover:bg-success/10")} title={wing.isActive ? "Deactivate" : "Activate"}>
