...
import { DepartmentSchema, type DepartmentType } from "../organization_management_types/super_admin_school_structure.types";
    ...
    <>
      ...
      <div className={cn(
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
          <form id="dept-form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              ...
              {errors.deptName && <span className="text-xs text-danger">{String(errors.deptName.message)}</span>}
            </div>
        ...
        <div className="p-6 border-t border-border bg-header flex items-center justify-end gap-3">
          ...
          <button type="submit" form="dept-form" disabled={isSubmitting} className="flex items-center gap-2 px-6 py-2 bg-primary text-black rounded-md hover:bg-primary-hover text-sm font-medium disabled:opacity-70">
