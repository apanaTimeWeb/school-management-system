    ...
    <div className="mt-8 flex flex-col gap-6 w-full max-w-7xl mx-auto pb-10">
      <div className="flex justify-between items-center mb-2">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">Advanced settings and features for 15 approval workflow</p>
        </div>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Workflow Builder</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Manage and configure workflow builder settings.</p>
