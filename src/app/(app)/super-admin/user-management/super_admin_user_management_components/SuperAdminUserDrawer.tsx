...
import { UserProfileSchema, type UserProfileType } from "@/app/(app)/super-admin/user-management/super_admin_user_management_types/super_admin_user_management.types";
