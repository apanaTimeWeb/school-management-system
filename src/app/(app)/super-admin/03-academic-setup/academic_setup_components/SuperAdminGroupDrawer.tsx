    ...
    <>
      ...
      <div className={cn(
        ...
        <div className="p-6 border-t border-border bg-header flex items-center justify-end gap-3">
          ...
          <button type="submit" form="group-form" disabled={isSubmitting} className="flex items-center gap-2 px-6 py-2 bg-primary text-black rounded-md hover:bg-primary-hover text-sm font-medium disabled:opacity-70">
