    ...
    <>
      ...
      <div className={cn(
          ...
          <form id="rollover-form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 border-b border-border pb-6">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.fromSessionId && <span className="text-xs text-danger">{String(errors.fromSessionId.message)}</span>}
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.toSessionName && <span className="text-xs text-danger">{String(errors.toSessionName.message)}</span>}
              </div>
        ...
        <div className="p-6 border-t border-border bg-header flex items-center justify-end gap-3">
          ...
          <button type="submit" form="rollover-form" disabled={isSubmitting} className="flex items-center gap-2 px-6 py-2 bg-primary text-black rounded-md hover:bg-primary-hover text-sm font-medium disabled:opacity-70">
            <FastForward size={16} />
